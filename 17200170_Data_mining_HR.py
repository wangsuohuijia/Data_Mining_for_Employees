...
data['CurrentEmployee'].value_counts()
check = pd.pivot_table(data,index=['JobRole', 'MonthlyIncome', 'StockOptionLevel'],
                       values=['CurrentEmployee'])
check.to_excel('job_income_solevel.xlsx')
...
# EducationLevel[data['Education']==1] = 'Education_level_1'
# EducationLevel[data['Education']==2] = 'Education_level_2'
# EducationLevel[data['Education']==3] = 'Education_level_3'
# EducationLevel[data['Education']==4] = 'Education_level_4'
# EducationLevel[data['Education']==5] = 'Education_level_5'
#
# EducationLevel[data['Education']=='Education_level_1'] = 1
# EducationLevel[data['Education']== 'Education_level_2'] = 2
# EducationLevel[data['Education']=='Education_level_3'] = 3
# EducationLevel[data['Education']=='Education_level_4'] = 4
# EducationLevel[data['Education']== 'Education_level_5'] = 5
#
# data['Education'] = EducationLevel
# data = one_hot(data, column='Education')
# print(data[['Education', 'Education_level_1','Education_level_2','Education_level_3',
#             'Education_level_4','Education_level_5']])
...
# F_model_data = model_data.drop(['CurrentEmployee'], axis=1, inplace=False)
# T_model_data = pd.DataFrame(model_data['CurrentEmployee'])
